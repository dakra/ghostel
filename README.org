...
:description: Evil, compile, eshell, tmux, comint, and input methods
:end:
...
| =M-x ghostel-tmux-reset=                              | Escape hatch: kill the control-mode subprocess and seal its pane buffers.              |
